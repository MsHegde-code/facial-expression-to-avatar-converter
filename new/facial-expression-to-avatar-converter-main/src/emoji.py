...
# /home/msh/Downloads
    ...
    frame1 = cv2.resize(frame1,(640, 500))
...
if __name__ == '__main__':
    ...
    lmain2.place(x=750, y=250)
    # window
    root.title("Photo To Avatar")
    root.geometry("1400x1000+100+10")
    root['bg'] = 'black'
    exitButton = Button(root, text='Close', fg="red",font=('Arial', 20, 'bold') , command=root.destroy).pack(side=BOTTOM)
