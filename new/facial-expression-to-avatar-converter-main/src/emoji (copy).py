...
def show_subject():
# /home/msh/Downloads
    cap1 = cv2.VideoCapture("/home/msh/Downloads/vid.mp4")
    ...
    bounding_box = cv2.CascadeClassifier(
        "/home/msh/anaconda3/lib/python3.11/site-packages/cv2/data/haarcascade_frontalface_default.xml")
...
def show_avatar():
    ...
    lmain3.configure(text=emotion_dict[show_text[0]], font=('arial', 30))
...
if __name__ == '__main__':
    ...
    root['bg'] = 'black'
    exitButton = Button(root, text='Close', fg="red",font=('arial', 30) , command=root.destroy).pack(side=BOTTOM)
